...
import { Sparkles, AlertCircle, ArrowRight, User, Loader2, Shield, Users, GraduationCap, Zap } from 'lucide-react';
...
export default function Login() {
  ...
  const handleDemoLogin = async (account: typeof DEMO_ACCOUNTS[0]) => {
    ...
    try {
      ...
      setError(`Demo login failed: ${err.message}. Make sure the server is running.`);
    } finally {
      setDemoLoading(null);
    }
  };
  ...
  const handleGuestLogin = () => {
    login('guest-token', { id: 999, name: 'Guest User', email: 'guest@campusclean.edu', role: 'student' } as any);
